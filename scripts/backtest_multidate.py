...
# (round-14, P1-5): 7/4 是周六非交易日，改为 7/3 周五
ALL_DATES = ["2026-06-26", "2026-06-29", "2026-06-30", "2026-07-01", "2026-07-02", "2026-07-03"]
...
def main():
    pred_to_cache = {
        # (round-12, C-scripts-2): 6/27 是周六非交易日，K线找不到会全部 missing，改为 6/29 周一
        # (round-15, C-scripts-4): actual_date 偏移修复 — 用 D2 (平仓日) 替代原 D1 (买入日)
        # 一日游策略: D0=分析日, D1=买入日(D0+1交易日), D2=平仓日(D0+2交易日)
        # tuple = (pred_date, actual_date=D2, cache_date=D2) — cache_date 与 actual_date 一致
        # 因 {cache_date}_get_stock_price_data.md 包含最近5天 close，取 D2 当天的 cache 才能同时含 D0 与 D2
        "2026-06-26": ("2026-06-26", "2026-06-30", "2026-06-30"),  # D0=6/26(周五), D1=6/29, D2=6/30
        "2026-06-29": ("2026-06-29", "2026-07-01", "2026-07-01"),  # D0=6/29(周一), D1=6/30, D2=7/1
        "2026-06-30": ("2026-06-30", "2026-07-02", "2026-07-02"),  # D0=6/30(周二), D1=7/1, D2=7/2
        "2026-07-01": ("2026-07-01", "2026-07-03", "2026-07-03"),  # D0=7/1(周三), D1=7/2, D2=7/3
        # (round-14, P1-5): 7/2 预测 → 7/3 买 → 7/6 卖 (周四预测→周五买→周一卖)
        "2026-07-02": ("2026-07-02", "2026-07-06", "2026-07-06"),
        # (round-14, P1-5): 7/3 周五 → 7/6 周一 → 7/7 周二（替换原 7/4 周六映射）
        "2026-07-03": ("2026-07-03", "2026-07-07", "2026-07-07"),
    }
