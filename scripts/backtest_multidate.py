...
def main():
    pred_to_cache = {
        ...
        "2026-06-26": ("2026-06-26", "2026-06-29", "2026-06-29"),
        ...
        # (round-14, P1-5): 7/2 预测 → 7/3 买 → 7/6 卖 (周五预测→周一买→周二卖)
        # actual_date 仍是 7/3, cache_date 仍是 7/4（K 线缓存按 actual_date 存）
        "2026-07-02": ("2026-07-02", "2026-07-03", "2026-07-04"),
        # (round-14, P1-5): 7/3 周五 → 7/6 周一 → 7/7 周二（替换原 7/4 周六映射）
        "2026-07-03": ("2026-07-03", "2026-07-06", "2026-07-06"),
    }
